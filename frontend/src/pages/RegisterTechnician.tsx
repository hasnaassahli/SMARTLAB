// src/pages/RegisterTechnician.tsx
...
const RegisterTechnician: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post('http://localhost:5000/api/technicians/register', form);
      setMessage("Technicien enregistré avec succès !");
            ...
            <div className="card-body p-5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="text-center">
                  <small className="text-muted">
                    Déjà un compte ? 
                    <a href="/login-technician" className="text-warning text-decoration-none ms-1">
                      Se connecter
                    </a>
                  </small>
                </div>
          ...
          <div className="text-center mt-4">
            <div className="mb-2">
              <small className="text-muted">
                ...
                <a href="/login-patient" className="text-warning text-decoration-none ms-1">
                  Connexion Patient
                </a>
              </small>
            </div>
            <div>
              <small className="text-muted">
                ...
                Inscription réservée aux techniciens autorisés
              </small>
            </div>
          </div>
        </div>
